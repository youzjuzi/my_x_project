...
DEFAULT_LETTERS_WEIGHTS = ROOT / "runs/letters_detect_yolov5m_v12/weights/best.pt"
DEFAULT_SOURCE = "0"
DEFAULT_IMGSZ = 640
DEFAULT_HAND_CONF = 0.25
DEFAULT_LETTERS_CONF = 0.25
...
def parse_args():
    ...
    parser.add_argument(
        "--letters-weights",
        type=str,
        default=str(DEFAULT_LETTERS_WEIGHTS),
    ...
    parser.add_argument("--letters-conf", type=float, default=DEFAULT_LETTERS_CONF, help="letters confidence threshold")
